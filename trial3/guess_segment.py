...
def generate_segment_code(guesses_value_path_dict, paths_to_any, segment_path, root, namespace):
    ...
    print 'xpath_from_code: '+xpath_from_code
    print 'xpath_to_code: '+xpath_to_code
    ...
    print 'xpath_from_time: '+xpath_from_time
    print 'xpath_to_time: '+xpath_to_time
    ...
    print 'carrier_flight_paths: '+carrier_flight_paths
